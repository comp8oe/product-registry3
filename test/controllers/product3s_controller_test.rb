...
class Product3sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product3" do
    assert_difference('Product3.count') do
      post product3s_url, params: { product3: { name: @product3.name, price: @product3.price, vendor: @product3.vendor } }
    end
  ...
  test "should update product3" do
    patch product3_url(@product3), params: { product3: { name: @product3.name, price: @product3.price, vendor: @product3.vendor } }
